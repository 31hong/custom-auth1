...
public class MyCustomAuthenticator implements Authenticator {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        if (deviceCredentialHash != null && !deviceCredentialHash.trim().isEmpty()) {
            ...
            try {
                // 同步调用服务器验证（耗时短，用户无感知）
                Map<String, Object> verifyResult = verifyWithCredentialServer(deviceCredentialHash);
...
public void action(AuthenticationFlowContext context) {
     ...
     */
    private Map<String, Object> verifyWithCredentialServer(String deviceCredentialHash) {
